...
class modExtra {
    function __construct(modX &$modx,array $config = array()) {
        ...
        $corePath = $this->modx->getOption('modextra.core_path',$config,$this->modx->getOption('core_path').'components/modxboilerplate/');
        $assetsUrl = $this->modx->getOption('modextra.assets_url',$config,$this->modx->getOption('assets_url').'components/modxboilerplate/');
