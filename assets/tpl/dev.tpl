...
<!-- headNav.tpl (chunk) -->
    <header role="banner">
        <hgroup>
            <h1 id="siteName"><a href="[[++site_url]]">[[++site_name]]</a></h1>[[++admin.tagLine:notempty=`
            <h2>[[++admin.tagLine]]</h2>`]]
        </hgroup>
    </header>
<!-- /headNav.tpl (chunk) -->
...
<!-- main content -->
    ...
    <!-- setting a TV to define some custom content (snippet calls…) -->[[*contentBefore:notempty=`
[[*contentbefore]]`]]
        <article id="main">
[[*content]]
        </article>
    <!-- setting a TV to define some custom content (snippet calls…) -->[[*contentAfter:notempty=`
[[*contentAfter]]`]]
    </div>
<!-- /main content -->
...
<!-- footer.tpl (chunk) -->
    <footer id="footer">
        ...
        <p>&copy; 2010[[If?
            ...
            &else=``
            &debug=`0`
            &die=`0`]]<!--if current year > 2010 then display "-current year"--> [[++site_name]]</p>
    </footer>
<!-- /footer.tpl (chunk) -->
